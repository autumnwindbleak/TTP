...
2. cd to TTP/Exercise1/

3. Type "ant" in terminal to compile all files

4. Type "ant ECTTPE1" in terminal to Run the program

5. Check the result file in the current path (e.g. "~/TTP/Exercise1/results/") 

6. The folder, `instances`, contains all instances for Exercise 1.
